...
//        File file1 = new File("D:\\io\\io1\\abc.txt");
        //下面的方法都是以给出的路径的最下面的文件或目录来看的 比如"D:\\io\\io1"就是看的io1，"D:\\io\\io1\\abc.txt"是看的abc.txt
        System.out.println(file1.getName());
        System.out.println(file1.getPath());
        System.out.println(file1.getAbsolutePath());
        System.out.println(file1.getAbsoluteFile());
...
//            System.out.println(f.getName());
    ...
    file1.renameTo(file2):要想此方法执行完，返回true。要求：
       file1的文件或目录必须存在，且file2的必须不存在，且file2所在的文件目录需要存在。
    * */
    @Test
    public void test4() {
        File file1 = new File("hello.txt");
        ...
        boolean renameSuccess = file1.renameTo(file2);//把file1的文件剪切到file2中并且重命名为file2的文件名
    ...
    * */
    ...
    public void test5() {
        ...
        System.out.println(file1.isFile());//实际存在的前提下去判断
...
//    @Test
//    public void test10(){
//        File file = new File("D:\\IdeaProjects\\JavaSECode\\chapter15_io_teacher");
