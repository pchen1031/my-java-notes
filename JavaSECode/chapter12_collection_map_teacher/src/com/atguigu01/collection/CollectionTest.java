...
public class CollectionTest {
    ...
    * */
    ...
    public void test(){
        ...
        coll.addAll(coll1);
//        coll.add(coll1); 把coll1整个当成一个整体加入coll
...
//        System.out.println(coll.size());//0
    ...
    @Test
    public void test555(){
        Collection collectiom = new ArrayList();
        collectiom.add(2);
//        collectiom.add("2");
        System.out.println(collectiom);
        collectiom.remove(2);
        System.out.println(collectiom);
    }
...
//        System.out.println(arr); 输出[Ljava.lang.Object;@7bb11784
        //hashCode():
    ...
    public void test7(){
        ...
        collection.add(new int[]{1,2,3,4});
